    ...
    function M() {
        if ("over" != d && "pass" != d) {
            ...
            if ("shooting" == d) {
                ...
                f ? (b = r * w(f.a), b = r * v(f.a) + u.sqrt(4 * h * h - b * b), D(a, b), d = "over", e.save().font("bold 18px sans-serif").textAlign("right").fillStyle("#f00").fillText("\u6302\u4e86\uff01", s - 10, k - 45).fillText("3\u79d2\u540e\u91cd\u65b0\u5f00\u59cb", s - 10, k -
                    20).restore(), setTimeout(G, 3E3)) : 1 > b ? D(a, t) : (n.push(K(a - A)), L(a), d = "idle", B || (d = "pass", localStorage.setItem("aaffuu-cxp", '{"aa":' + (l + 1) + "}"), e.save().font("bold 18px sans-serif").textAlign("right").fillStyle("#060").fillText("\u5b8c\u7f8e\u8fc7\u5173\uff01", s - 10, k - 45).fillText("3\u79d2\u540e\u4e0b\u4e00\u5173", s - 10, k - 20).restore(), setTimeout(G, 3E3)))
            }
